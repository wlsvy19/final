...
<body>
   ...
   <div id = "footer_box">
      나나랜드은 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br/>
      ...
      - 이메일로 계정 등록한 경우: 이메일, 비밀번호, 이름, 성별, 닉네임, 생년월일, 휴대전화번호<br/>
      - 페이스북(Facebook) 로그인 연동: 페이스북 회원을 판단하기 위한 식별자 정보, 페이스북에서 제공하는 공개 프로필 정보<br/>
      - 카카오 로그인 연동: 카카오 ID 및 카카오에서 제공하는 정보<br/>
      - 네이버 로그인 연동: 네이버 ID 및 네이버에서 제공하는 정보<br/>
      - 재화 또는 서비스 제공 시: 이름, 이메일, 휴대전화번호, 주소, 자택 전화번호, 결제 정보(신용카드번호 등) <br/>
      ② 서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그, 쿠키, 접속 IP, 결제 기록, 불량이용 기록이 생성되어 수집될 수 있습니다.<br/>
      <br/>
      나. 수집방법<br/>
      회사는 다음과 같은 방법으로 개인정보를 수집합니다.<br/>
      - 서비스 가입이나 사용 중 이용자의 자발적 제공을 통한 수집<br/>
      - 회원의 선택에 따라 카카오, 네이버, 페이스북, 구글 등의 아이디를 이용하여 로그인하는 회원의 경우 해당 협력회사로부터 자동으로 수집<br/>
      - 그 외 협력회사로부터 제공<br/>
      - 생성정보 수집 툴을 통한 수집<br/>
      <br/>
      ...
      회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 5년간 회원의 정보를 보유할 수 있습니다. <br/>
      <br/>
      ...
      * 회사는 1년 동안 회사의 서비스를 이용하지 않은 이용자의 개인정보는 ‘정보통신망 이용촉진 및 정보보호등에 관한 법률 제29조’ 에 근거하여 이용자에게 사전통지하고 개인정보를 파기하거나 별도로 분리하여 저장 관리합니다.<br/>
      <br/>
      <h4>5. 개인정보 제공</h4>
      <br/>
      ...
      ① 위탁 대상자 : 택배사 ㈜두손컴퍼니, CJ택배, 우체국택배, 현대택배, 대한통운, 한진택배 외 기타택배사 <br/>
      ② 위탁업무 내용 : 물품 배송 등의 물류 업무<br/>
      ③ 위탁 대상자 : PG사 KG이니시스, ㈜나이스정보통신 ㈜다날, LG데이콤, 모빌리언스, KCP, 올앳 <br/>
      ④ 위탁업무 내용 : 결제처리(휴대폰, 무통장 입금, 계좌이체, 신용카드, 지류상품권 및 기타 결제수단, 환불계좌 인증) 및 결제도용 방지<br/>
      ⑤ 위탁 대상자 :  ㈜알리는사람<br/>
      ⑥ 위탁업무 내용 : 문자발송 등 고지사항 전달 <br/>
      <br/>
      ...
      ③ 구글 애널리틱스를 이용한 웹로그 분석<br/>
      회사는 구글(Google)에서 제공하는 웹 분석 도구인 구글 애널리틱스를 이용하고 있으며, 이 경우 이용자 개인을 식별할 수 없도록 비식별화 처리된 정보를 이용합니다. 이용자는 구글 애널리틱스 Opt-out Browser Add-on 을 이용하거나, 쿠키 설정 거부를 통해 구글 애널리틱스 이용을 거부할 수 있습니다.<br/>
      <br/>
      <h4>9. 개인정보에 관한 민원서비스</h4>
      <br/>
      회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다.<br/>
      <br/>
      ① 개인정보관리담당자 <br/>
      - 성명 : 이혜린<br/>
      - 이메일 : hyerin@nanaland.co.kr<br/>
      <br/>
      ② 개인정보관리책임자 <br/>
      - 성명 : 이혜린<br/>
      - 이메일 : ceo@nanaland.co.kr<br/>
      <br/>
      ...
      <br/>
      <h4>10. 기타</h4>
      회사의 서비스 내에 링크되어 있는 웹사이트 등 타 서비스들이 개인정보를 수집하는 행위에 대해서는 본 나나랜드 개인정보처리방침이 적용되지 않음을 알려드립니다.<br/>
      <br/>
      <h4>11. 고지의 의무</h4>
      <br/>
      현 개인정보처리방침 내용 추가, 삭제 및 수정이 있을 시에는 시행일 최소 7일전부터 서비스 웹사이트(https://hobbyful.co.kr)의 '공지사항'을 통해 공고할 것입니다.<br/>
      <br/>
      부칙<br/>
      본 개인정보 이용정책은 2018년 09월 07일부터 적용됩니다.<br/>
   </div>
