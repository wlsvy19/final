...
public class ShoppingDTO {
	...
	private double shop_starcnt; // 데이터 타입 바꿈

	private List<Shopping_ReplyDTO> replyList; // 댓글 정보를 받을 부분

	private Shopping_CartDTO cartList; // 상품 수량 받을 부분
	...
	public double getShop_starcnt() {
		return shop_starcnt;
	}

	public void setShop_starcnt(double shop_starcnt) {
		this.shop_starcnt = shop_starcnt;
	}

	public List<Shopping_ReplyDTO> getReplyList() {
		return replyList;
	}

	public void setReplyList(List<Shopping_ReplyDTO> replyList) {
		this.replyList = replyList;
	}

	public Shopping_CartDTO getCartList() {
		return cartList;
	}

	public void setCartList(Shopping_CartDTO cartList) {
